          ...
          <?php foreach ($query->fetchAll() as $fila) { ?>
           <tr>
            ...
            <td class="text-center">
              <a class="btn btn-warning btn-xs" href="servicios_edit.php?id=<?php echo $fila['id']; ?>"> <i class="fa fa-edit"></i></a>
              <a class="btn btn-danger btn-xs" href="servicios_delete.php?id=<?php echo $fila['id']; ?>"> <i class="fa fa-remove"></i></a>
            </td>
          </tr>
          <?php } ?>
        </tbody>
