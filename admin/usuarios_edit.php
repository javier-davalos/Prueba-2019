...
<div class="panel">
      ...
      <div class="panel">
        <div class="row">
          <?php if($total >0) {
           ...
           ?>
            <form action="usuarios_edit.php" method="POST">
                ...
                <div class="form-group col-md-4">
                 ...
                 <div class="form-group col-md-2">
                    ...
                    <select name="activo" class="form-control" required>
                        <option value="1" <?php if($usuario['activo'] ==1 ){echo 'select'; } ?> >Activo</option>
                        <option value="0" <?php if($usuario['activo'] ==0 ){echo 'select'; } ?> >Inactivo</option>
                ...
                <div class="col-md-2">
                        <br>
                         <input type="hidden" name="id" value="<?php echo $usuario['id'] ?>" required class="form-control">
          ...
          <?php  }else { 
            ?>
            <a href="usuarios.php" class="btn btn-warning"> El usuario no existe, volver a la lista</a>
          <?php   } ?>
        </div>
      </div>
    </section>
